      ...
      <div class="container">
        ...
        <div class="form-group">
          <label class="form">SKU</label>
            <input type="text" name="sku" id="" class="form-control" placeholder="" aria-describedby="helpId" />
            <span class="text-danger">
            @error('sku')
                    {{$message}}
                @enderror
        ...
        <div class="form-group">
          <label class="form">Short Description</label>
            <input type="text" name="short_description" id="" class="form-control" placeholder="" aria-describedby="helpId" />
            <span class="text-danger">
